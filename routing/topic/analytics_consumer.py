...
channel.queue_bind(queue=queue.method.queue, exchange='topic', routing_key='*.europe.*')
# Change routing key as per requirement
# channel.queue_bind(queue=queue.method.queue, exchange='topic', routing_key='#.payments')
